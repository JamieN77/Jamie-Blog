...
const Footer = () => {
  ...
  const handleSubscribeClick = (event) => {
    event.preventDefault();
    setShowModal(true);
    console.log("I'm called", showModal);
  };
      ...
      {showModal && (
        <div className="modal">
          <div className="modal-content">
            ...
            <p>
              Sorry I can't afford to send you email now, but I will definitely
              do when I'm rich!
            </p>
          </div>
        </div>
          ...
          <div className="row justify-content-between">
            ...
            <div className="col-lg-2 col-md-3 col-6 mb-4 mt-2">
              ...
              <ul className="list-unstyled footer-list">
                ...
                <li className="list-item">
                  <Link to="/dev">Privacy Policy</Link>
                </li>
                <li className="list-item">
                  <Link to="/dev">Terms Conditions</Link>
                </li>
              </ul>
            </div>
            ...
            <div className="col-lg-2 col-md-3 col-6 mb-4 mt-2">
              ...
              <ul className="list-unstyled footer-list">
                <li className="list-item">
                  <Link to="/dev">facebook</Link>
                </li>
                <li className="list-item">
                  <Link to="/dev">twitter</Link>
                </li>
                <li className="list-item">
            ...
            <div className="col-md-3 mb-4 mt-2">
              ...
              <form className="subscription" onSubmit={handleSubscribeClick}>
